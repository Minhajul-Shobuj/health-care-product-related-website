...
const Home = () => {
    ...
    return (
        <div className="my-5">
            ...
            <div>
                <div className="fw-bolder mx-3 d-flex justify-content-center align-items-center my-3 text-warning">
                    <img style={{ width: '500px', height: '300px' }} src={image1} alt="" />
                    <p className="mx-5 fs-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Non repellat atque doloremque veritatis reprehenderit, vel explicabo eaque exercitationem autem expedita error officia, libero tempore voluptate quae voluptatem pariatur molestias temporibus!</p>
                </div>
                <div className="fw-bolder mx-3 d-flex justify-content-center align-items-center my-3 text-warning">
                    <p className="mx-5 fs-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Non repellat atque doloremque veritatis reprehenderit, vel explicabo eaque exercitationem autem expedita error officia, libero tempore voluptate quae voluptatem pariatur molestias temporibus!</p>
                    <img style={{ width: '500px', height: '300px' }} src={image2} alt="" />
                </div>
            </div>
            <div>
                <h1 className="fs-2 w-25 rounded-pill ms-3 fw-bolder text-success bg-dark">Best selling Products</h1>
            </div>
